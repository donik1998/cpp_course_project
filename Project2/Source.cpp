...
int main(){
	...
	while (main_menu_choice != 0){//main muenu
		cout << "Welcome to our hotel 'Xuykin Dom'" << endl;
					  ...
					  while (true){// Book a room menu
						  ...
						  case(1) : {	system("cls");
							  ...
							  for (int i = 0; i < 50; i++){
								  ...
								  else if (rooms[i].get_capacity()<ord_numofguest){
									  cout << "Largest possible number of guests in Ordinal rooms is 2" << endl;
									  break;
								  }
								  else{
									  continue;
						  ...
						  case(2) : {	system("cls");
							  ...
							  for (int i = 0; i < 50; i++){
								  if (rooms[i].get_capacity() >= adv_numofguest && rooms[i].get_availability() == true && rooms[i].get_room_type() == "Advanced"){
									  ...
									  cout << "Maximum capacity of Advanced room is 3" << endl;
									  break;
								  }
								  else{
									  continue;
						  ...
						  case(3) : {
										...
										for (int i = 0; i < 50; i++){
											if (rooms[i].get_capacity() >= lux_numofguest && rooms[i].get_availability() == true && rooms[i].get_room_type() == "Lux"){
												...
												cout << "Maximum number of guests in Lux room is 4" << endl;
												break;
											}
											else{
												continue;
						  ...
						  case(4) : {
										...
										for (int i = 0; i < 50; i++){
											if (rooms[i].get_capacity() >= adv_lux_numofguest && rooms[i].get_availability() == true && rooms[i].get_room_type() == "Advanced lux"){
												...
												cout << "Maximum number of guests in Advanced lux is 6" << endl;
												break;
											}
											else{
												continue;
